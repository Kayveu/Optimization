...
4.2: Inputs would be log(p(Gettin Caught))  or -log(1 - p(Getting Caught))
...
colnames(dist) <- c(' ES Days','ES Date', 'EF Days', 'EF Date', 'LF Days', 'LF Date', 'LS Start', 'LS Date', 'Slack')
